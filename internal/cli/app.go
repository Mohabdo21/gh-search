...
func parseArgs(args []string, stderr io.Writer) (config, error) {
	...
	fs.Usage = func() {
		...
		_, _ = fmt.Fprintln(stderr, "  gh-search <repo-url> --query <keywords> [--state open|closed|all] [--type issue|discussion|all] [--limit N] [--sort relevance|created|created-asc|created-desc|updated|updated-asc|updated-desc] [--json] [--plain-links]")
